                    ...
                    <div class="tab-pane" id="agendamento">
                        <form id="form-agendamento" class="form-horizontal col-md-8">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4" for="emailserver">Período</label>
                                    <div class="col-md-8">
                                        <?php
                                        $perido = array('manha'=>'Manhã','Tarde','Noite'=>'Noite');
                                        echo $this->Form->input('Agendamento.periodo',array('type'=>'select','options'=>$perido,'class'=>'form-control select-box','label'=>false));?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo $this->Form->input('Agendamento.agendamento_id', array('type' => 'hidden','id'=>'agendamento_id')); ?>

                                        <?php echo $this->Form->input('Agendamento.atendimento_id', array('type' => 'hidden', 'value' => $this->request->data['Atendimento']['atendimento_id'])); ?>
                                        <?php $data_agendamento = !empty($this->request->data['Agendamento']['data_agendamento']) ? $this->request->data['Agendamento']['data_agendamento'] : date('d/m/Y'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php $contato = !empty($this->request->data['Agendamento']['contato']) ? $this->request->data['Agendamento']['contato'] : ""; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <?php $observacao = !empty($this->request->data['Agendamento']['observacoes']) ? $this->request->data['Agendamento']['observacoes'] : ""; ?>
                        ...
                        <fieldset>
                            ...
                            <form id="form-rat" class="form-horizontal col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="message" class="col-lg-4">Observações</label>
                                    <div class="col-md-8">
                                        <textarea class="form-control" name="data[Rat][informacoes]" id="observacoes-rat" rows="4"></textarea>
                                    </div>
                                </div>
