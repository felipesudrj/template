			...
			<div class="widget stacked">
				...
				<div class="widget-content">
					<div class="stats">
						...
						<form action="/" role="form" c>
						<div class="col-md-5">
							
							
								<div class="form-group">
								<label for="from">Data de Agendamento de</label>
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<select id="select1" name="select1" class="form-control">
					                ...
					                <option value="5">5</option>
										...
										<label>Status de ordem de serviço</label>
										 <select id="select1" name="select1" class="form-control">
											<option value="">Todos...</option>
											<option value="1">Aguardando agendamento</option>
								...
								<div class="form-group">
									...
									<button type="button" class="btn btn-success pull-right">Gerar relatório</button>
								</div>
						</div> <!-- /stat -->
